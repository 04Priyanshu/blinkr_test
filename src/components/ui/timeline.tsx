  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-12 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 text-white max-w-4xl mx-auto text-center">
      ...
      <div className="relative max-w-7xl mx-auto pb-5">
        {data.map((item, index) => (
          ...
          >
            ...
            <div className="absolute left-1/2 transform -translate-x-1/2 flex flex-col items-center z-10">
              <div className="h-10 w-10 rounded-full bg-black flex items-center justify-center border-2 border-neutral-800 shadow-lg">
        ...
        <div
          ...
          className="absolute left-1/2 transform -translate-x-1/2 top-0 overflow-hidden w-[2px] bg-[linear-gradient(to_bottom,var(--tw-gradient-stops))] from-transparent from-[0%] via-neutral-700 to-transparent to-[99%] [mask-image:linear-gradient(to_bottom,transparent_0%,black_10%,black_90%,transparent_100%)] z-0"
        >
          <motion.div
            style={{
